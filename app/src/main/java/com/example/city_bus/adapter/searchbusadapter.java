...
public class searchbusadapter extends RecyclerView.Adapter<searchbusadapter.Holder> {

    private List<Buses> list;


    public searchbusadapter(List<Buses> list) {
        this.list = list;
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_show_bus_result_after_searc,parent,false);
